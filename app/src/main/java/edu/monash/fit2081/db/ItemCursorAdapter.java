...
public class    ItemCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        TextView shapeId =  view.findViewById(R.id.delete_id);

        TextView shapeType = view.findViewById(R.id.shapeType);
        TextView shapeX = view.findViewById(R.id.shapeX);
        TextView shapeY =  view.findViewById(R.id.shapeY);
        ...
        final Button updateBtn =  view.findViewById(R.id.btnEdit);
